...
async function downloadGhCli(version) {
  const toolDirectoryName = `gh_${version}_macOS_amd64`;
  const downloadUrl = `https://github.com/cli/cli/releases/download/v${version}/gh_${version}_macOS_amd64.tar.gz`;
